...
export const InputField = ({ title, secureText, className, icons }: InputFieldProps) => {
    const textInputStyle = [TEXT_INPUT_STYLE, className].filter(Boolean).join(" ");
    
    return (
        <View className="relative">
            <TextInput  placeholder={title} secureTextEntry={secureText} className={textInputStyle} />
