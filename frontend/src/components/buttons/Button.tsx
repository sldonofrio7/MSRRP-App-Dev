...
const PRESSABLE_STYLE = "flex justify-center items-center bg-red-orange ml-20 mr-20 p-2 rounded-md w-40"
const TEXT_STYLE = "font-primary text-base text-white"

export const Button = ({ title, onPress, className, textClassName }: ButtonProps) => {
